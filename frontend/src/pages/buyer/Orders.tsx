          ...
          {filteredOrders.length === 0 ? (
            ...
            filteredOrders.map((order: any, index: number) => (
              ...
              >
                ...
                <div className="rounded-2xl sm:rounded-3xl border border-white/[0.05] bg-[#0F1720]/40 backdrop-blur-xl overflow-hidden shadow-2xl hover:border-emerald-500/30 transition-all duration-500">

                  {/* Item Header */}

                  <div className="px-4 sm:px-6 py-4 sm:py-5 bg-white/[0.02] border-b border-white/[0.05] flex flex-col md:flex-row md:items-center justify-between gap-3 sm:gap-4">

                    <div className="flex items-center gap-3 sm:gap-4">

                      <div className="h-10 w-10 sm:h-12 sm:w-12 rounded-xl sm:rounded-2xl bg-gray-900 border border-white/[0.1] flex items-center justify-center">
                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-2 sm:gap-3">
                          ...
                          <h3 className="text-base sm:text-lg font-black text-white tracking-tight uppercase group-hover:text-emerald-400 transition-colors">Order #{order.id}</h3>

                          <span className="px-2 sm:px-3 py-0.5 sm:py-1 rounded-full text-[8px] sm:text-[9px] font-black uppercase tracking-widest bg-emerald-500/10 border border-emerald-500/20 text-emerald-400">
                        ...
                        <div className="flex items-center gap-3 sm:gap-4 mt-1 text-[9px] sm:text-[10px] font-bold text-[#586069] uppercase tracking-wider">
                    ...
                    <div className="flex flex-col items-start md:items-end gap-1.5 sm:gap-2">
                      ...
                      <p className="text-[9px] sm:text-[10px] font-black text-[#8B949E] uppercase tracking-widest leading-none">
                      ...
                      <div className="flex items-center gap-1 sm:gap-1.5 mt-0.5 sm:mt-1">
                        ...
                        {['ordered', 'approved', 'processing', 'shipped', 'delivered'].map((step, i) => {
                          ...
                          return (
                            ...
                            <div key={step} className={`h-0.75 sm:h-1 rounded-full transition-all duration-500 ${isActive ? 'w-3 sm:w-4 bg-emerald-500' : 'w-0.75 sm:w-1 bg-white/[0.1]'}`} />
                  ...
                  <div className="p-4 sm:p-6">
                      ...
                      {order.items?.map((item: any) => (
                        ...
                        <div key={item.id} className="flex items-center gap-3 sm:gap-4 p-3 sm:p-4 bg-white/[0.02] border border-white/[0.03] rounded-xl sm:rounded-2xl hover:bg-white/[0.05] transition-all">
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <p className="text-xs sm:text-sm font-black text-white truncate">{item.product?.name}</p>

                            <p className="text-[9px] sm:text-[10px] font-bold text-[#586069] uppercase mt-0.5">Qty: {item.quantity}</p>

                            <p className="text-[10px] sm:text-[11px] font-black text-emerald-400 mt-1">${Number(item.price).toFixed(2)}</p>
                    ...
                    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between pt-4 sm:pt-6 border-t border-white/[0.05] gap-3 sm:gap-4 text-[10px] sm:text-xs font-bold text-[#586069] uppercase tracking-widest">
                      ...
                      <div className="flex items-center gap-3 sm:gap-4">
                        ...
                        {order.shipping_address && (
                          ...
                          <div className="flex items-center gap-1.5 sm:gap-2 max-w-[150px] sm:max-w-xs truncate">
                      ...
                      <div className="flex items-center gap-2 sm:gap-3">
                        ...
                        <motion.button
                          ...
                          className="h-8 sm:h-10 px-4 sm:px-6 rounded-lg sm:rounded-xl bg-white/[0.03] border border-white/[0.08] text-white text-[9px] sm:text-[10px] font-black uppercase tracking-widest hover:bg-emerald-500/10 hover:border-emerald-500/30 transition-all flex items-center gap-1.5 sm:gap-2"
                        ...
                        <motion.button
                          ...
                          className="h-8 sm:h-10 px-3 sm:px-4 rounded-lg sm:rounded-xl bg-white/[0.03] border border-white/[0.08] text-[#8B949E] hover:text-white hover:bg-emerald-500/10 hover:border-emerald-500/30 transition-all"
