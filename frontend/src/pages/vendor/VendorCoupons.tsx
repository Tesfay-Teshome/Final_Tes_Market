            ...
            <div className="relative z-10 px-4 sm:px-6 lg:px-8 max-w-[1700px] mx-auto pt-8">
                ...
                {loading ? (
                    ...
                    >
                        ...
                        <p className="text-[#8B949E] text-sm font-medium italic mb-8">Deploy your first discount protocol to attract more customers.</p>
                        <motion.button
                            whileHover={{ scale: 1.05 }}
                            whileTap={{ scale: 0.95 }}
                            onClick={handleCreate}
                            className="px-8 py-3.5 bg-gradient-to-r from-emerald-500 to-emerald-400 text-black text-[11px] font-black uppercase tracking-widest rounded-xl shadow-lg"
                        >
                    ...
                    >
                        {coupons.map((coupon, idx) => (
                            <motion.div
                                ...
                                className="group relative overflow-hidden rounded-3xl border border-white/[0.04] bg-[#0c1214]/70 backdrop-blur-3xl p-6 hover:border-[#3CFF9E]/30 transition-all duration-500 shadow-2xl"
                            >
                                {/* Hover glow */}
                ...
                {isModalOpen && (
                    ...
                    >
                        <motion.div
                            ...
                            className="bg-[#0D1117] border border-white/10 rounded-[32px] max-w-2xl w-full shadow-[0_0_100px_rgba(0,0,0,0.5)] max-h-[90vh] overflow-y-auto"
